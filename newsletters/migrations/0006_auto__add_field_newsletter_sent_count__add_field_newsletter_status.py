...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Newsletter.sent_count'
        db.add_column(u'newsletters_newsletter', 'sent_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Newsletter.status'
        db.add_column(u'newsletters_newsletter', 'status',
                      self.gf('django.db.models.fields.CharField')(default='new', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Newsletter.sent_count'
        db.delete_column(u'newsletters_newsletter', 'sent_count')

        # Deleting field 'Newsletter.status'
        db.delete_column(u'newsletters_newsletter', 'status')
