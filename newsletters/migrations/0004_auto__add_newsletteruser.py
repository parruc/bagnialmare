...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'newsletters_newsletteruser', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='newsletter_user', unique=True, null=True, to=orm['auth.User'])),
            ('old_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
        ))
        db.send_create_signal(u'newsletters', ['NewsletterUser'])


    def backwards(self, orm):
        # Deleting model 'NewsletterUser'
        db.delete_table(u'newsletters_newsletteruser')
    ...
    models = {
        ...
        u'newsletters.newsletteruser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'old_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': "'name'", 'unique_with': '()'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'newsletter_user'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"})
        }
    }
