...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'booking_booking', (
            ...
            ('bagno', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bookings', to=orm['bagni.Bagno'])),
            ('start', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('end', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('sunbeds', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('umbrellas', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=100)),
            ('cell', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
    ...
    models = {
        'bagni.bagno': {
            ...
            'description': ('ckeditor.fields.RichTextField', [], {'max_length': '350', 'blank': 'True'}),
            'description_en': ('ckeditor.fields.RichTextField', [], {'max_length': '350', 'null': 'True', 'blank': 'True'}),
            'description_it': ('ckeditor.fields.RichTextField', [], {'max_length': '350', 'null': 'True', 'blank': 'True'}),
        ...
        'bagni.service': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'max_length': '2000', 'blank': 'True'}),
        ...
        u'booking.booking': {
            ...
            'bagno': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bookings'", 'to': "orm['bagni.Bagno']"}),
            'cell': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '100'}),
            'end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'sunbeds': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'umbrellas': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        }
    }
