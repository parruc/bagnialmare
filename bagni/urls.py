...
#    url(_(r'^about-us$'), views.AboutUsView.as_view(), name="about-us",),
    url(_(r'^concorso2014/$'), views.Concorso2014View.as_view(), name="concorso-2014",),
...
#    url(_(r'^services/$'), views.ServicesView.as_view(), name="services"),
    ...
    url(_(r'^stabilimenti-balneari/services/(?P<facility_slug>[-\w]+)/(?P<neighbourhood_slug>[-\w]+)/$'), views.BagniByFacilityAndNeighbourhoodView.as_view(),  name="bagni-by-facility-and-neighbourhood"),
