...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bagni_neighbourhood', (
            ...
            ('description_en', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True)),
            ('description_it', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True)),
            ('municipality', self.gf('django.db.models.fields.related.ForeignKey')(related_name='neighbourhoods', to=orm['bagni.Municipality'])),
        ...
        db.send_create_signal(u'bagni', ['Neighbourhood'])

        # Adding field 'Bagno.neighbourhood'
        db.add_column(u'bagni_bagno', 'neighbourhood',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bagni', null=True, to=orm['bagni.Neighbourhood']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Neighbourhood'
        db.delete_table(u'bagni_neighbourhood')

        # Deleting field 'Bagno.neighbourhood'
        db.delete_column(u'bagni_bagno', 'neighbourhood_id')
