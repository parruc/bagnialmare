...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.seo_name'
        db.add_column(u'bagni_service', 'seo_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.seo_name_en'
        db.add_column(u'bagni_service', 'seo_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.seo_name_it'
        db.add_column(u'bagni_service', 'seo_name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.aliases'
        db.add_column(u'bagni_service', 'aliases',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.aliases_en'
        db.add_column(u'bagni_service', 'aliases_en',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.aliases_it'
        db.add_column(u'bagni_service', 'aliases_it',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Bagno.description'
        db.alter_column(u'bagni_bagno', 'description', self.gf('ckeditor.fields.RichTextField')(max_length=2000))

        # Changing field 'Bagno.description_en'
        db.alter_column(u'bagni_bagno', 'description_en', self.gf('ckeditor.fields.RichTextField')(max_length=2000, null=True))

        # Changing field 'Bagno.description_it'
        db.alter_column(u'bagni_bagno', 'description_it', self.gf('ckeditor.fields.RichTextField')(max_length=2000, null=True))

    def backwards(self, orm):
        # Deleting field 'Service.seo_name'
        db.delete_column(u'bagni_service', 'seo_name')

        # Deleting field 'Service.seo_name_en'
        db.delete_column(u'bagni_service', 'seo_name_en')

        # Deleting field 'Service.seo_name_it'
        db.delete_column(u'bagni_service', 'seo_name_it')

        # Deleting field 'Service.aliases'
        db.delete_column(u'bagni_service', 'aliases')

        # Deleting field 'Service.aliases_en'
        db.delete_column(u'bagni_service', 'aliases_en')

        # Deleting field 'Service.aliases_it'
        db.delete_column(u'bagni_service', 'aliases_it')


        # Changing field 'Bagno.description'
        db.alter_column(u'bagni_bagno', 'description', self.gf('django.db.models.fields.TextField')(max_length=2000))

        # Changing field 'Bagno.description_en'
        db.alter_column(u'bagni_bagno', 'description_en', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True))

        # Changing field 'Bagno.description_it'
        db.alter_column(u'bagni_bagno', 'description_it', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True))
