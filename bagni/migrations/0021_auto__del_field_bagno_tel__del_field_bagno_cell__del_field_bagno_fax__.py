...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bagno.tel'
        db.delete_column(u'bagni_bagno', 'tel')

        # Deleting field 'Bagno.cell'
        db.delete_column(u'bagni_bagno', 'cell')

        # Deleting field 'Bagno.fax'
        db.delete_column(u'bagni_bagno', 'fax')
    ...
    def backwards(self, orm):
        # Adding field 'Bagno.tel'
        db.add_column(u'bagni_bagno', 'tel',
        ...
        # Adding field 'Bagno.fax'
        db.add_column(u'bagni_bagno', 'fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=125, blank=True),
                      keep_default=False)
