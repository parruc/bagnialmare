...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bagni_telephone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('name_en', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('name_it', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('bagno', self.gf('django.db.models.fields.related.ForeignKey')(related_name='telephones', to=orm['bagni.Bagno'])),
        ))
        db.send_create_signal(u'bagni', ['Telephone'])


    def backwards(self, orm):
        # Deleting model 'Telephone'
        db.delete_table(u'bagni_telephone')
