...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Telephone.name_it'
        db.delete_column(u'bagni_telephone', 'name_it')

        # Deleting field 'Telephone.name_en'
        db.delete_column(u'bagni_telephone', 'name_en')
    ...
    def backwards(self, orm):
        # Adding field 'Telephone.name_it'
        db.add_column(u'bagni_telephone', 'name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Telephone.name_en'
        db.add_column(u'bagni_telephone', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        db.add_column(u'bagni_bagno', 'slug_it',
                      self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, null=True, blank=True),
                      keep_default=False)
