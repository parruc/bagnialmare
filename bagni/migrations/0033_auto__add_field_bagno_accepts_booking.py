...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bagno.accepts_booking'
        db.add_column(u'bagni_bagno', 'accepts_booking',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bagno.accepts_booking'
        db.delete_column(u'bagni_bagno', 'accepts_booking')


    models = {
        'bagni.bagno': {
            'Meta': {'object_name': 'Bagno'},
            'accepts_booking': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
