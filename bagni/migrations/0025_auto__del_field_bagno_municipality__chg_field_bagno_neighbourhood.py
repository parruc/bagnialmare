...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bagno.neighbourhood'
        db.alter_column(u'bagni_bagno', 'neighbourhood_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['bagni.Neighbourhood']))

    def backwards(self, orm):
        # Adding field 'Bagno.municipality'
        db.add_column(u'bagni_bagno', 'municipality',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='bagni2', null=True, to=orm['bagni.Municipality'], blank=True),
                      keep_default=False)


        # Changing field 'Bagno.neighbourhood'
        db.alter_column(u'bagni_bagno', 'neighbourhood_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bagni.Neighbourhood']))
    ...
    models = {
        u'bagni.bagno': {
            ...
            'neighbourhood': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bagni'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['bagni.Neighbourhood']"}),
