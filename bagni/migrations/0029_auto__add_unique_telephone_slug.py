...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Telephone', fields ['slug']
        db.create_unique(u'bagni_telephone', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Telephone', fields ['slug']
        db.delete_unique(u'bagni_telephone', ['slug'])
